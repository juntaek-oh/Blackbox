...
→ webcam_blackbox_config.json에서 device_id 변경 또는 장치 확인
...
브랜치 푸시 (git push origin feature/AmazingFeature)

Pull Request 생성

🐛 버그 리포트
Issues 탭에 아래 정보를 포함하여 제출해 주세요:

OS, Python 버전, 전체 에러 메시지, 재현 단계 등
